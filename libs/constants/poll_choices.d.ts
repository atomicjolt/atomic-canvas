export namespace listPollChoicesInPoll {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace getSinglePollChoice {
    const type_1: string;
...
export namespace createSinglePollChoice {
    const type_2: string;
...
export namespace updateSinglePollChoice {
    const type_3: string;
...
export namespace deletePollChoice {
    const type_4: string;
