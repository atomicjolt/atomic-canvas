export namespace createLiveAssessmentResults {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace listLiveAssessmentResults {
    const type_1: string;
...
export namespace createOrFindLiveAssessment {
    const type_2: string;
...
export namespace listLiveAssessments {
    const type_3: string;
