export namespace getNewQuiz {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace listNewQuizzes {
    const type_1: string;
...
export namespace createNewQuiz {
    const type_2: string;
...
export namespace updateSingleQuiz {
    const type_3: string;
...
export namespace deleteNewQuiz {
    const type_4: string;
