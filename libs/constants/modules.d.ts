...
export namespace reLockModuleProgressions {
    const type_5: string;
...
export namespace listModuleItems {
    const type_6: string;
...
export namespace showModuleItem {
    const type_7: string;
...
export namespace createModuleItem {
    const type_8: string;
...
export namespace updateModuleItem {
    const type_9: string;
...
export namespace selectMasteryPath {
...
export namespace deleteModuleItem {
...
export namespace markModuleItemAsDoneNotDone {
...
export namespace getModuleItemSequence {
...
export namespace markModuleItemRead {
