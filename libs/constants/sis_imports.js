...
exports.abortAllPendingSisImports = exports.abortSisImport = exports.restoreWorkflowStatesOfSisImportedItems = exports.getSisImportStatus = exports.importSisData = exports.getCurrentImportingSisImport = exports.getSisImportList = void 0;
//
// SIS Imports
//
// Get SIS import list
...
exports.getSisImportList = { type: 'GET_SIS_IMPORT_LIST', method: 'get', key: 'get_sis_import_listget_sis_import_list_account_id', required: ['account_id'] };
...
exports.getCurrentImportingSisImport = { type: 'GET_CURRENT_IMPORTING_SIS_IMPORT', method: 'get', key: 'get_current_importing_sis_importget_current_importing_sis_import_account_id', required: ['account_id'] };
// Import SIS data
...
exports.importSisData = { type: 'IMPORT_SIS_DATA', method: 'post', key: 'import_sis_dataimport_sis_data_account_id', required: ['account_id'] };
...
exports.getSisImportStatus = { type: 'GET_SIS_IMPORT_STATUS', method: 'get', key: 'get_sis_import_statusget_sis_import_status_{account_id}_{id}', required: ['account_id', 'id'] };
...
exports.restoreWorkflowStatesOfSisImportedItems = { type: 'RESTORE_WORKFLOW_STATES_OF_SIS_IMPORTED_ITEMS', method: 'put', key: 'restore_workflow_states_of_sis_imported_itemsrestore_workflow_states_of_sis_imported_items_{account_id}_{id}', required: ['account_id', 'id'] };
// Abort SIS import
...
exports.abortSisImport = { type: 'ABORT_SIS_IMPORT', method: 'put', key: 'abort_sis_importabort_sis_import_{account_id}_{id}', required: ['account_id', 'id'] };
...
exports.abortAllPendingSisImports = { type: 'ABORT_ALL_PENDING_SIS_IMPORTS', method: 'put', key: 'abort_all_pending_sis_importsabort_all_pending_sis_imports_account_id', required: ['account_id'] };
//# sourceMappingURL=sis_imports.js.map