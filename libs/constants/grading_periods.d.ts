export namespace listGradingPeriodsAccounts {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace listGradingPeriodsCourses {
    const type_1: string;
...
export namespace getSingleGradingPeriod {
    const type_2: string;
...
export namespace updateSingleGradingPeriod {
    const type_3: string;
...
export namespace deleteGradingPeriodCourses {
    const type_4: string;
...
export namespace deleteGradingPeriodAccounts {
    const type_5: string;
...
export namespace batchUpdateGradingPeriodsCourses {
    const type_6: string;
...
export namespace batchUpdateGradingPeriodsGradingPeriodSets {
    const type_7: string;
