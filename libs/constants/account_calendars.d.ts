export namespace listAvailableAccountCalendars {
    const type: string;
    const method: string;
    const key: string;
    const required: never[];
}
export namespace getSingleAccountCalendar {
    const type_1: string;
...
export namespace updateCalendar {
    const type_2: string;
...
export namespace updateSeveralCalendars {
    const type_3: string;
...
export namespace listAllAccountCalendars {
    const type_4: string;
...
export namespace countOfAllVisibleAccountCalendars {
    const type_5: string;
