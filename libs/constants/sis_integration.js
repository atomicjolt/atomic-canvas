...
exports.disableAssignmentsCurrentlyEnabledForGradeExportToSis = exports.retrieveAssignmentsEnabledForGradeExportToSisCourses = exports.retrieveAssignmentsEnabledForGradeExportToSisAccounts = void 0;
//
// SIS Integration
//
...
exports.retrieveAssignmentsEnabledForGradeExportToSisAccounts = { type: 'RETRIEVE_ASSIGNMENTS_ENABLED_FOR_GRADE_EXPORT_TO_SIS_ACCOUNTS', method: 'get', key: 'retrieve_assignments_enabled_for_grade_export_to_sis_accountsretrieve_assignments_enabled_for_grade_export_to_sis_accounts_account_id', required: ['account_id'] };
// Retrieve assignments enabled for grade export to SIS
// Retrieve a list of published assignments flagged as "post_to_sis".
// See the Assignments API for more details on assignments.
// Assignment group and section information are included for convenience.
...
exports.retrieveAssignmentsEnabledForGradeExportToSisCourses = { type: 'RETRIEVE_ASSIGNMENTS_ENABLED_FOR_GRADE_EXPORT_TO_SIS_COURSES', method: 'get', key: 'retrieve_assignments_enabled_for_grade_export_to_sis_coursesretrieve_assignments_enabled_for_grade_export_to_sis_courses_course_id', required: ['course_id'] };
...
exports.disableAssignmentsCurrentlyEnabledForGradeExportToSis = { type: 'DISABLE_ASSIGNMENTS_CURRENTLY_ENABLED_FOR_GRADE_EXPORT_TO_SIS', method: 'put', key: 'disable_assignments_currently_enabled_for_grade_export_to_sisdisable_assignments_currently_enabled_for_grade_export_to_sis_course_id', required: ['course_id'] };
//# sourceMappingURL=sis_integration.js.map