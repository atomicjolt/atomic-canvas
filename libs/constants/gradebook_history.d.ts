export namespace daysInGradebookHistoryForThisCourse {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace detailsForGivenDateInGradebookHistoryForThisCourse {
    const type_1: string;
...
export namespace listsSubmissions {
    const type_2: string;
...
export namespace listUncollatedSubmissionVersions {
    const type_3: string;
