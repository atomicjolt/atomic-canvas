export namespace listContentExportsCourses {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace listContentExportsGroups {
    const type_1: string;
...
export namespace listContentExportsUsers {
    const type_2: string;
...
export namespace showContentExportCourses {
    const type_3: string;
...
export namespace showContentExportGroups {
    const type_4: string;
...
export namespace showContentExportUsers {
    const type_5: string;
...
export namespace exportContentCourses {
    const type_6: string;
...
export namespace exportContentGroups {
    const type_7: string;
...
export namespace exportContentUsers {
    const type_8: string;
