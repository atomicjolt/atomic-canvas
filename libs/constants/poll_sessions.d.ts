export namespace listPollSessionsForPoll {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace getResultsForSinglePollSession {
    const type_1: string;
...
export namespace createSinglePollSession {
    const type_2: string;
...
export namespace updateSinglePollSession {
    const type_3: string;
...
export namespace deletePollSession {
    const type_4: string;
...
export namespace openPollSession {
    const type_5: string;
...
export namespace closeOpenedPollSession {
    const type_6: string;
...
export namespace listOpenedPollSessions {
    const type_7: string;
...
export namespace listClosedPollSessions {
    const type_8: string;
