export namespace createContentShare {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace listContentSharesSent {
    const type_1: string;
...
export namespace listContentSharesReceived {
    const type_2: string;
...
export namespace getUnreadSharesCount {
    const type_3: string;
...
export namespace getContentShare {
    const type_4: string;
...
export namespace removeContentShare {
    const type_5: string;
...
export namespace addUsersToContentShare {
    const type_6: string;
...
export namespace updateContentShare {
    const type_7: string;
