export namespace importOutcomesAccounts {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace importOutcomesCourses {
    const type_1: string;
...
export namespace getOutcomeImportStatusAccounts {
    const type_2: string;
...
export namespace getOutcomeImportStatusCourses {
    const type_3: string;
...
export namespace getIdsOfOutcomeGroupsCreatedAfterSuccessfulImportAccounts {
    const type_4: string;
...
export namespace getIdsOfOutcomeGroupsCreatedAfterSuccessfulImportCourses {
    const type_5: string;
