export namespace listCalendarEvents {
    const type: string;
    const method: string;
    const key: string;
    const required: never[];
}
export namespace listCalendarEventsForUser {
    const type_1: string;
...
export namespace createCalendarEvent {
    const type_2: string;
...
export namespace getSingleCalendarEventOrAssignment {
    const type_3: string;
...
export namespace reserveTimeSlotParticipantId {
    const type_5: string;
...
export namespace updateCalendarEvent {
    const type_6: string;
...
export namespace deleteCalendarEvent {
    const type_7: string;
...
export namespace saveEnabledAccountCalendars {
    const type_8: string;
    ...
    const key_8: string;
    export { key_8 as key };
    const required_8: never[];
    export { required_8 as required };
}
export namespace setCourseTimetable {
    const type_9: string;
...
export namespace getCourseTimetable {
...
export namespace createOrUpdateEventsDirectlyForCourseTimetable {
