export namespace listExternalFeedsCourses {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace listExternalFeedsGroups {
    const type_1: string;
...
export namespace createExternalFeedCourses {
    const type_2: string;
...
export namespace createExternalFeedGroups {
    const type_3: string;
...
export namespace deleteExternalFeedCourses {
    const type_4: string;
...
export namespace deleteExternalFeedGroups {
    const type_5: string;
