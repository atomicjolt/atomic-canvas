export namespace listAppointmentGroups {
    const type: string;
    const method: string;
    const key: string;
    const required: never[];
}
export namespace createAppointmentGroup {
    const type_1: string;
...
export namespace getSingleAppointmentGroup {
    const type_2: string;
...
export namespace updateAppointmentGroup {
    const type_3: string;
...
export namespace deleteAppointmentGroup {
    const type_4: string;
...
export namespace listUserParticipants {
    const type_5: string;
...
export namespace listStudentGroupParticipants {
    const type_6: string;
...
export namespace getNextAppointment {
    const type_7: string;
