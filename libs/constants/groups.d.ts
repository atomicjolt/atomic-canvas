export namespace listYourGroups {
    const type: string;
    const method: string;
    const key: string;
    const required: never[];
}
export namespace listGroupsAvailableInContextAccounts {
    const type_1: string;
...
export namespace listGroupsAvailableInContextCourses {
    const type_2: string;
...
export namespace getSingleGroup {
    const type_3: string;
...
export namespace createGroupGroups {
    const type_4: string;
    ...
    const key_4: string;
    export { key_4 as key };
    const required_4: never[];
    export { required_4 as required };
}
export namespace createGroupGroupCategories {
    const type_5: string;
...
export namespace inviteOthersToGroup {
    const type_8: string;
...
export namespace listGroupSUsers {
    const type_9: string;
...
export namespace groupsUploadFile {
...
export namespace groupsPreviewProcessedHtml {
...
export namespace groupActivityStream {
...
export namespace groupActivityStreamSummary {
...
export namespace groupsPermissions {
...
export namespace listGroupMemberships {
...
export namespace getSingleGroupMembershipMemberships {
...
export namespace getSingleGroupMembershipUsers {
...
export namespace createMembership {
...
export namespace updateMembershipMemberships {
...
export namespace updateMembershipUsers {
...
export namespace leaveGroupMemberships {
...
export namespace leaveGroupUsers {
