...
exports.deleteReport = exports.statusOfReport = exports.indexOfReports = exports.startReport = exports.listAvailableReports = void 0;
//
// Account Reports
//
...
exports.listAvailableReports = { type: 'LIST_AVAILABLE_REPORTS', method: 'get', key: 'list_available_reportslist_available_reports_account_id', required: ['account_id'] };
// Start a Report
...
exports.startReport = { type: 'START_REPORT', method: 'post', key: 'start_reportstart_report_{account_id}_{report}', required: ['account_id', 'report'] };
// Index of Reports
...
exports.indexOfReports = { type: 'INDEX_OF_REPORTS', method: 'get', key: 'index_of_reportsindex_of_reports_{account_id}_{report}', required: ['account_id', 'report'] };
// Status of a Report
...
exports.statusOfReport = { type: 'STATUS_OF_REPORT', method: 'get', key: 'status_of_reportstatus_of_report_{account_id}_{report}_{id}', required: ['account_id', 'report', 'id'] };
// Delete a Report
...
exports.deleteReport = { type: 'DELETE_REPORT', method: 'delete', key: 'delete_reportdelete_report_{account_id}_{report}_{id}', required: ['account_id', 'report', 'id'] };
//# sourceMappingURL=account_reports.js.map