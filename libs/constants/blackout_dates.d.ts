export namespace listBlackoutDatesCourses {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace listBlackoutDatesAccounts {
    const type_1: string;
...
export namespace getSingleBlackoutDateCourses {
    const type_2: string;
...
export namespace getSingleBlackoutDateAccounts {
    const type_3: string;
...
export namespace newBlackoutDateCourses {
    const type_4: string;
...
export namespace newBlackoutDateAccounts {
    const type_5: string;
...
export namespace createBlackoutDateCourses {
    const type_6: string;
...
export namespace createBlackoutDateAccounts {
    const type_7: string;
...
export namespace updateBlackoutDateCourses {
    const type_8: string;
...
export namespace updateBlackoutDateAccounts {
    const type_9: string;
...
export namespace deleteBlackoutDateCourses {
...
export namespace deleteBlackoutDateAccounts {
...
export namespace updateListOfBlackoutDates {
