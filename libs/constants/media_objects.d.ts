export namespace listMediaTracksForMediaObjectOrAttachmentMediaObjects {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace listMediaTracksForMediaObjectOrAttachmentMediaAttachments {
    const type_1: string;
...
export namespace updateMediaTracksMediaObjects {
    const type_2: string;
...
export namespace updateMediaTracksMediaAttachments {
    const type_3: string;
...
export namespace listMediaObjectsMediaObjects {
    const type_4: string;
...
export namespace listMediaObjectsCoursesMediaObjects {
    const type_5: string;
...
export namespace listMediaObjectsGroupsMediaObjects {
    const type_6: string;
...
export namespace listMediaObjectsMediaAttachments {
    const type_7: string;
    ...
    const key_7: string;
    export { key_7 as key };
    const required_7: never[];
    export { required_7 as required };
}
export namespace listMediaObjectsCoursesMediaAttachments {
    const type_8: string;
...
export namespace listMediaObjectsGroupsMediaAttachments {
    const type_9: string;
...
export namespace updateMediaObjectMediaObjects {
...
export namespace updateMediaObjectMediaAttachments {
