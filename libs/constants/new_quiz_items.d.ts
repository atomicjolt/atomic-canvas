export namespace getQuizItem {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace listQuizItems {
    const type_1: string;
...
export namespace createQuizItem {
    const type_2: string;
...
export namespace updateQuizItem {
    const type_3: string;
...
export namespace deleteQuizItem {
    const type_4: string;
...
export namespace getItemsMediaUploadUrl {
    const type_5: string;
