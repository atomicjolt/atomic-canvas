export namespace createEnrollmentTerm {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace updateEnrollmentTerm {
    const type_1: string;
...
export namespace deleteEnrollmentTerm {
    const type_2: string;
...
export namespace listEnrollmentTerms {
    const type_3: string;
...
export namespace retrieveEnrollmentTerm {
    const type_4: string;
