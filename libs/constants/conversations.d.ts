export namespace listConversations {
    const type: string;
    const method: string;
    const key: string;
...
export namespace getRunningBatches {
    const type_2: string;
...
export namespace getSingleConversation {
    const type_3: string;
...
export namespace editConversation {
    const type_4: string;
...
export namespace addRecipients {
    const type_7: string;
...
export namespace batchUpdateConversations {
