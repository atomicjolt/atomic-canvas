export namespace listAuthenticationProviders {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace addAuthenticationProvider {
    const type_1: string;
...
export namespace updateAuthenticationProvider {
    const type_2: string;
...
export namespace getAuthenticationProvider {
    const type_3: string;
...
export namespace deleteAuthenticationProvider {
    const type_4: string;
...
export namespace showAccountAuthSettings {
    const type_5: string;
...
export namespace updateAccountAuthSettings {
    const type_6: string;
