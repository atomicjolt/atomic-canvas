...
var updateCustomGradebookColumn = exports.updateCustomGradebookColumn = { type: 'UPDATE_CUSTOM_GRADEBOOK_COLUMN', method: 'put', key: 'update_custom_gradebook_columnupdate_custom_gradebook_column_{course_id}_{id}', required: ['course_id', 'id'] };
...
var deleteCustomGradebookColumn = exports.deleteCustomGradebookColumn = { type: 'DELETE_CUSTOM_GRADEBOOK_COLUMN', method: 'delete', key: 'delete_custom_gradebook_columndelete_custom_gradebook_column_{course_id}_{id}', required: ['course_id', 'id'] };
...
var bulkUpdateColumnData = exports.bulkUpdateColumnData = { type: 'BULK_UPDATE_COLUMN_DATA', method: 'put', key: 'bulk_update_column_databulk_update_column_data_course_id', required: ['course_id'] };