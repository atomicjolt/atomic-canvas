export namespace listGroupCategoriesForContextAccounts {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace listGroupCategoriesForContextCourses {
    const type_1: string;
...
export namespace getSingleGroupCategory {
    const type_2: string;
...
export namespace createGroupCategoryAccounts {
    const type_3: string;
...
export namespace createGroupCategoryCourses {
    const type_4: string;
...
export namespace importCategoryGroups {
    const type_5: string;
...
export namespace updateGroupCategory {
    const type_6: string;
...
export namespace deleteGroupCategory {
    const type_7: string;
...
export namespace listGroupsInGroupCategory {
    const type_8: string;
...
export namespace exportGroupsInAndUsersInCategory {
    const type_9: string;
...
export namespace listUsersInGroupCategory {
...
export namespace assignUnassignedMembers {
