export namespace listCustomGradebookColumns {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace createCustomGradebookColumn {
    const type_1: string;
...
export namespace updateCustomGradebookColumn {
    const type_2: string;
...
export namespace deleteCustomGradebookColumn {
    const type_3: string;
...
export namespace reorderCustomColumns {
    const type_4: string;
...
export namespace listEntriesForColumn {
    const type_5: string;
...
export namespace updateColumnData {
    const type_6: string;
...
export namespace bulkUpdateColumnData {
    const type_7: string;
