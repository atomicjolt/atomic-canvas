export namespace redirectToRootOutcomeGroupForContextGlobal {
    const type: string;
    const method: string;
    const key: string;
    const required: never[];
}
export namespace redirectToRootOutcomeGroupForContextAccounts {
    const type_1: string;
...
export namespace redirectToRootOutcomeGroupForContextCourses {
    const type_2: string;
...
export namespace getAllOutcomeGroupsForContextAccounts {
    const type_3: string;
...
export namespace getAllOutcomeGroupsForContextCourses {
    const type_4: string;
...
export namespace getAllOutcomeLinksForContextAccounts {
    const type_5: string;
...
export namespace getAllOutcomeLinksForContextCourses {
    const type_6: string;
...
export namespace showOutcomeGroupGlobal {
    const type_7: string;
...
export namespace showOutcomeGroupAccounts {
    const type_8: string;
...
export namespace showOutcomeGroupCourses {
    const type_9: string;
...
export namespace updateOutcomeGroupGlobal {
...
export namespace updateOutcomeGroupAccounts {
...
export namespace updateOutcomeGroupCourses {
...
export namespace deleteOutcomeGroupGlobal {
...
export namespace deleteOutcomeGroupAccounts {
...
export namespace deleteOutcomeGroupCourses {
...
export namespace listLinkedOutcomesGlobal {
...
export namespace listLinkedOutcomesAccounts {
...
export namespace listLinkedOutcomesCourses {
...
export namespace createLinkOutcomeGlobal {
...
export namespace createLinkOutcomeGlobalOutcomeId {
...
export namespace createLinkOutcomeAccounts {
...
export namespace createLinkOutcomeAccountsOutcomeId {
...
export namespace createLinkOutcomeCourses {
...
export namespace createLinkOutcomeCoursesOutcomeId {
...
export namespace unlinkOutcomeGlobal {
...
export namespace unlinkOutcomeAccounts {
...
export namespace unlinkOutcomeCourses {
...
export namespace listSubgroupsGlobal {
...
export namespace listSubgroupsAccounts {
...
export namespace listSubgroupsCourses {
...
export namespace createSubgroupGlobal {
...
export namespace createSubgroupAccounts {
...
export namespace createSubgroupCourses {
...
export namespace importOutcomeGroupGlobal {
...
export namespace importOutcomeGroupAccounts {
...
export namespace importOutcomeGroupCourses {
