export namespace listUserLoginsAccounts {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace listUserLoginsUsers {
    const type_1: string;
...
export namespace kickoffPasswordRecoveryFlow {
    const type_2: string;
...
export namespace createUserLogin {
    const type_3: string;
...
export namespace editUserLogin {
    const type_4: string;
...
export namespace deleteUserLogin {
    const type_5: string;
