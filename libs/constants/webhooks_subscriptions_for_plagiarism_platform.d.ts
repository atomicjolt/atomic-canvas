export namespace createWebhookSubscription {
    const type: string;
    const method: string;
    const key: string;
    const required: never[];
}
export namespace deleteWebhookSubscription {
    const type_1: string;
...
export namespace showSingleWebhookSubscription {
    const type_2: string;
...
export namespace updateWebhookSubscription {
    const type_3: string;
...
export namespace listAllWebhookSubscriptionForToolProxy {
    const type_4: string;
