export namespace listPreferencesCommunicationChannelId {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace listPreferencesType {
    const type_1: string;
...
export namespace listOfPreferenceCategories {
    const type_2: string;
...
export namespace getPreferenceCommunicationChannelId {
    const type_3: string;
...
export namespace getPreferenceType {
    const type_4: string;
...
export namespace updatePreferenceCommunicationChannelId {
    const type_5: string;
...
export namespace updatePreferenceType {
    const type_6: string;
...
export namespace updatePreferencesByCategory {
    const type_7: string;
...
export namespace updateMultiplePreferencesCommunicationChannelId {
    const type_8: string;
...
export namespace updateMultiplePreferencesType {
    const type_9: string;
