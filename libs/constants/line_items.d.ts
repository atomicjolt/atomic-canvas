export namespace createLineItem {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace updateLineItem {
    const type_1: string;
...
export namespace listLineItems {
    const type_3: string;
...
export namespace deleteLineItem {
    const type_4: string;
