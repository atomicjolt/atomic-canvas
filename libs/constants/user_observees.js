...
var listObservers = exports.listObservers = { type: 'LIST_OBSERVERS', method: 'get', key: 'list_observerslist_observers_user_id', required: ['user_id'] };
...
var showObserver = exports.showObserver = { type: 'SHOW_OBSERVER', method: 'get', key: 'show_observershow_observer_{user_id}_{observer_id}', required: ['user_id', 'observer_id'] };
...
var createObserverPairingCode = exports.createObserverPairingCode = { type: 'CREATE_OBSERVER_PAIRING_CODE', method: 'post', key: 'create_observer_pairing_codecreate_observer_pairing_code_user_id', required: ['user_id'] };