...
var daysInGradebookHistoryForThisCourse = exports.daysInGradebookHistoryForThisCourse = { type: 'DAYS_IN_GRADEBOOK_HISTORY_FOR_THIS_COURSE', method: 'get', key: 'days_in_gradebook_history_for_this_coursedays_in_gradebook_history_for_this_course_course_id', required: ['course_id'] };
...
var listsSubmissions = exports.listsSubmissions = { type: 'LISTS_SUBMISSIONS', method: 'get', key: 'lists_submissionslists_submissions_{course_id}_{date}_{grader_id}_{assignment_id}', required: ['course_id', 'date', 'grader_id', 'assignment_id'] };
