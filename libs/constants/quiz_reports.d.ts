export namespace retrieveAllQuizReports {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace createQuizReport {
    const type_1: string;
...
export namespace getQuizReport {
    const type_2: string;
...
export namespace abortGenerationOfReportOrRemovePreviouslyGeneratedOne {
    const type_3: string;
