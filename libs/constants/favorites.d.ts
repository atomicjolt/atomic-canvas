export namespace listFavoriteCourses {
    const type: string;
    const method: string;
    const key: string;
    const required: never[];
}
export namespace listFavoriteGroups {
    const type_1: string;
...
export namespace addCourseToFavorites {
    const type_2: string;
...
export namespace addGroupToFavorites {
    const type_3: string;
...
export namespace removeCourseFromFavorites {
    const type_4: string;
...
export namespace removeGroupFromFavorites {
    const type_5: string;
...
export namespace resetCourseFavorites {
    const type_6: string;
    ...
    const key_6: string;
    export { key_6 as key };
    const required_6: never[];
    export { required_6 as required };
}
export namespace resetGroupFavorites {
    const type_7: string;
