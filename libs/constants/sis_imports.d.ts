export namespace getSisImportList {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace getCurrentImportingSisImport {
    const type_1: string;
...
export namespace importSisData {
    const type_2: string;
...
export namespace getSisImportStatus {
    const type_3: string;
...
export namespace restoreWorkflowStatesOfSisImportedItems {
    const type_4: string;
...
export namespace abortSisImport {
    const type_5: string;
...
export namespace abortAllPendingSisImports {
    const type_6: string;
