export namespace listGradingPeriodSets {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace createGradingPeriodSet {
    const type_1: string;
...
export namespace updateGradingPeriodSet {
    const type_2: string;
...
export namespace deleteGradingPeriodSet {
    const type_3: string;
