export namespace listUserCommunicationChannels {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace createCommunicationChannel {
    const type_1: string;
...
export namespace deleteCommunicationChannelId {
    const type_2: string;
...
export namespace deleteCommunicationChannelType {
    const type_3: string;
...
export namespace deletePushNotificationEndpoint {
    const type_4: string;
