...
export namespace listAssignmentsAssignments {
    const type_1: string;
...
export namespace listAssignmentsAssignmentGroups {
    const type_2: string;
...
export namespace listAssignmentsForUser {
    const type_3: string;
...
export namespace duplicateAssignnment {
    const type_4: string;
...
export namespace getSingleAssignment {
    const type_5: string;
...
export namespace editAssignment {
    const type_7: string;
...
export namespace bulkUpdateAssignmentDates {
    const type_8: string;
...
export namespace listAssignmentOverrides {
    const type_9: string;
...
export namespace getSingleAssignmentOverride {
...
export namespace redirectToAssignmentOverrideForGroup {
...
export namespace redirectToAssignmentOverrideForSection {
...
export namespace createAssignmentOverride {
...
export namespace updateAssignmentOverride {
...
export namespace deleteAssignmentOverride {
...
export namespace batchRetrieveOverridesInCourse {
...
export namespace batchCreateOverridesInCourse {
...
export namespace batchUpdateOverridesInCourse {
