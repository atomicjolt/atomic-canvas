export namespace listAssignmentGroups {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace getAssignmentGroup {
    const type_1: string;
...
export namespace createAssignmentGroup {
    const type_2: string;
...
export namespace editAssignmentGroup {
    const type_3: string;
...
export namespace destroyAssignmentGroup {
    const type_4: string;
