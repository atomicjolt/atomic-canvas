export namespace listQuestionsInQuizOrSubmission {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace getSingleQuizQuestion {
    const type_1: string;
...
export namespace createSingleQuizQuestion {
    const type_2: string;
...
export namespace updateExistingQuizQuestion {
    const type_3: string;
...
export namespace deleteQuizQuestion {
    const type_4: string;
