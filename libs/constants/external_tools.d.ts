export namespace listExternalToolsCourses {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace listExternalToolsAccounts {
    const type_1: string;
...
export namespace listExternalToolsGroups {
    const type_2: string;
...
export namespace getSessionlessLaunchUrlForExternalToolCourses {
    const type_3: string;
...
export namespace getSessionlessLaunchUrlForExternalToolAccounts {
    const type_4: string;
...
export namespace getSingleExternalToolCourses {
    const type_5: string;
...
export namespace getSingleExternalToolAccounts {
    const type_6: string;
...
export namespace createExternalToolCourses {
    const type_7: string;
...
export namespace createExternalToolAccounts {
    const type_8: string;
...
export namespace editExternalToolCourses {
    const type_9: string;
...
export namespace editExternalToolAccounts {
...
export namespace deleteExternalToolCourses {
...
export namespace deleteExternalToolAccounts {
...
export namespace addToolToRceFavorites {
...
export namespace removeToolFromRceFavorites {
...
export namespace getVisibleCourseNavigationTools {
    ...
    const required_15: never[];
    export { required_15 as required };
}
export namespace getVisibleCourseNavigationToolsForSingleCourse {
