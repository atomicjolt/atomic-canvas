...
var duplicatePage = {
  type: 'DUPLICATE_PAGE',
  method: 'post',
  key: 'duplicate_pageduplicate_page_{course_id}_{url}',
...
var showPageCourses = {
  ...
  method: 'get',
  key: 'show_page_coursesshow_page_courses_{course_id}_{url}',
  required: ['course_id', 'url']
}; // Show page
// Retrieve the content of a wiki page
//
...
var showPageGroups = {
  ...
  method: 'get',
  key: 'show_page_groupsshow_page_groups_{group_id}_{url}',
  required: ['group_id', 'url']
}; // Update/create page
...
//   wiki_page[front_page]
// }
// return canvasRequest(update_create_page_courses, {course_id, url}, body);

exports.showPageGroups = showPageGroups;
var updateCreatePageCourses = {
  type: 'UPDATE_CREATE_PAGE_COURSES',
  method: 'put',
  key: 'update_create_page_coursesupdate_create_page_courses_{course_id}_{url}',
  required: ['course_id', 'url']
}; // Update/create page
// Update the title or contents of a wiki page
//
...
//   wiki_page[front_page]
// }
// return canvasRequest(update_create_page_groups, {group_id, url}, body);

exports.updateCreatePageCourses = updateCreatePageCourses;
var updateCreatePageGroups = {
  type: 'UPDATE_CREATE_PAGE_GROUPS',
  method: 'put',
  key: 'update_create_page_groupsupdate_create_page_groups_{group_id}_{url}',
  required: ['group_id', 'url']
}; // Delete page
// Delete a wiki page
//
...
var deletePageCourses = {
  ...
  method: 'delete',
  key: 'delete_page_coursesdelete_page_courses_{course_id}_{url}',
  required: ['course_id', 'url']
}; // Delete page
// Delete a wiki page
//
...
var deletePageGroups = {
  ...
  method: 'delete',
  key: 'delete_page_groupsdelete_page_groups_{group_id}_{url}',
  required: ['group_id', 'url']
}; // List revisions
...
var listRevisionsCourses = {
  ...
  method: 'get',
  key: 'list_revisions_courseslist_revisions_courses_{course_id}_{url}',
  required: ['course_id', 'url']
}; // List revisions
// A paginated list of the revisions of a page. Callers must have update rights on the page in order to see page history.
//
...
var listRevisionsGroups = {
  ...
  method: 'get',
  key: 'list_revisions_groupslist_revisions_groups_{group_id}_{url}',
  required: ['group_id', 'url']
}; // Show revision
...
var showRevisionCoursesLatest = {
  ...
  method: 'get',
  key: 'show_revision_courses_latestshow_revision_courses_latest_{course_id}_{url}',
  required: ['course_id', 'url']
}; // Show revision
// Retrieve the metadata and optionally content of a revision of the page.
// Note that retrieving historic versions of pages requires edit rights.
...
var showRevisionGroupsLatest = {
  ...
  method: 'get',
  key: 'show_revision_groups_latestshow_revision_groups_latest_{group_id}_{url}',
  required: ['group_id', 'url']
}; // Show revision
// Retrieve the metadata and optionally content of a revision of the page.
// Note that retrieving historic versions of pages requires edit rights.
...
var showRevisionCoursesRevisionId = {
  ...
  method: 'get',
  key: 'show_revision_courses_revision_idshow_revision_courses_revision_id_{course_id}_{url}_{revision_id}',
  required: ['course_id', 'url', 'revision_id']
}; // Show revision
// Retrieve the metadata and optionally content of a revision of the page.
// Note that retrieving historic versions of pages requires edit rights.
//
...
var showRevisionGroupsRevisionId = {
  ...
  method: 'get',
  key: 'show_revision_groups_revision_idshow_revision_groups_revision_id_{group_id}_{url}_{revision_id}',
  required: ['group_id', 'url', 'revision_id']
}; // Revert to revision
...
var revertToRevisionCourses = {
  ...
  method: 'post',
  key: 'revert_to_revision_coursesrevert_to_revision_courses_{course_id}_{url}_{revision_id}',
  required: ['course_id', 'url', 'revision_id']
}; // Revert to revision
// Revert a page to a prior revision.
//
...
var revertToRevisionGroups = {
  ...
  method: 'post',
  key: 'revert_to_revision_groupsrevert_to_revision_groups_{group_id}_{url}_{revision_id}',
  required: ['group_id', 'url', 'revision_id']
};
