export namespace getCurrentSettingsForAccountOrCourseCourses {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace getCurrentSettingsForAccountOrCourseAccounts {
    const type_1: string;
...
export namespace enableDisableOrClearExplicitCspSettingCourses {
    const type_2: string;
...
export namespace enableDisableOrClearExplicitCspSettingAccounts {
    const type_3: string;
...
export namespace lockOrUnlockCurrentCspSettingsForSubAccountsAndCourses {
    const type_4: string;
...
export namespace addAllowedDomainToAccount {
    const type_5: string;
...
export namespace addMultipleAllowedDomainsToAccount {
    const type_6: string;
...
export namespace retrieveReportedCspViolationsForAccount {
    const type_7: string;
...
export namespace removeDomainFromAccount {
    const type_8: string;
