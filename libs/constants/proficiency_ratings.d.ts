export namespace createUpdateProficiencyRatingsAccounts {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace createUpdateProficiencyRatingsCourses {
    const type_1: string;
...
export namespace getProficiencyRatingsAccounts {
    const type_2: string;
...
export namespace getProficiencyRatingsCourses {
    const type_3: string;
