export namespace listCollaborationsCourses {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace listCollaborationsGroups {
    const type_1: string;
...
export namespace listMembersOfCollaboration {
    const type_2: string;
...
export namespace listPotentialMembersCourses {
    const type_3: string;
...
export namespace listPotentialMembersGroups {
    const type_4: string;
