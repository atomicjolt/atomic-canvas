...
exports.getCurrentQuizSubmissionTimes = exports.completeQuizSubmissionTurnItIn = exports.updateStudentQuestionScoresAndComments = exports.createQuizSubmissionStartQuizTakingSession = exports.getSingleQuizSubmission = exports.getQuizSubmission = exports.getAllQuizSubmissions = void 0;
//
// Quiz Submissions
//
...
exports.getAllQuizSubmissions = { type: 'GET_ALL_QUIZ_SUBMISSIONS', method: 'get', key: 'get_all_quiz_submissionsget_all_quiz_submissions_{course_id}_{quiz_id}', required: ['course_id', 'quiz_id'] };
...
exports.getQuizSubmission = { type: 'GET_QUIZ_SUBMISSION', method: 'get', key: 'get_quiz_submissionget_quiz_submission_{course_id}_{quiz_id}', required: ['course_id', 'quiz_id'] };
...
exports.getSingleQuizSubmission = { type: 'GET_SINGLE_QUIZ_SUBMISSION', method: 'get', key: 'get_single_quiz_submissionget_single_quiz_submission_{course_id}_{quiz_id}_{id}', required: ['course_id', 'quiz_id', 'id'] };
...
exports.createQuizSubmissionStartQuizTakingSession = { type: 'CREATE_QUIZ_SUBMISSION_START_QUIZ_TAKING_SESSION', method: 'post', key: 'create_quiz_submission_start_quiz_taking_sessioncreate_quiz_submission_start_quiz_taking_session_{course_id}_{quiz_id}', required: ['course_id', 'quiz_id'] };
...
exports.updateStudentQuestionScoresAndComments = { type: 'UPDATE_STUDENT_QUESTION_SCORES_AND_COMMENTS', method: 'put', key: 'update_student_question_scores_and_commentsupdate_student_question_scores_and_comments_{course_id}_{quiz_id}_{id}', required: ['course_id', 'quiz_id', 'id'] };
...
exports.completeQuizSubmissionTurnItIn = { type: 'COMPLETE_QUIZ_SUBMISSION_TURN_IT_IN', method: 'post', key: 'complete_quiz_submission_turn_it_incomplete_quiz_submission_turn_it_in_{course_id}_{quiz_id}_{id}', required: ['course_id', 'quiz_id', 'id'] };
...
exports.getCurrentQuizSubmissionTimes = { type: 'GET_CURRENT_QUIZ_SUBMISSION_TIMES', method: 'get', key: 'get_current_quiz_submission_timesget_current_quiz_submission_times_{course_id}_{quiz_id}_{id}', required: ['course_id', 'quiz_id', 'id'] };
//# sourceMappingURL=quiz_submissions.js.map