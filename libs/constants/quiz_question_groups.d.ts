export namespace getSingleQuizGroup {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace createQuestionGroup {
    const type_1: string;
...
export namespace updateQuestionGroup {
    const type_2: string;
...
export namespace deleteQuestionGroup {
    const type_3: string;
...
export namespace reorderQuestionGroups {
    const type_4: string;
