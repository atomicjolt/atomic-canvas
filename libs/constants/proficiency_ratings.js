...
exports.createUpdateProficiencyRatingsAccounts = { type: 'CREATE_UPDATE_PROFICIENCY_RATINGS_ACCOUNTS', method: 'post', key: 'create_update_proficiency_ratings_accountscreate_update_proficiency_ratings_accounts_account_id', required: ['account_id'] };
// Create/update proficiency ratings
// Create or update account-level proficiency ratings. These ratings will apply to all
// sub-accounts, unless they have their own account-level proficiency ratings defined.
//
...
exports.createUpdateProficiencyRatingsCourses = { type: 'CREATE_UPDATE_PROFICIENCY_RATINGS_COURSES', method: 'post', key: 'create_update_proficiency_ratings_coursescreate_update_proficiency_ratings_courses_course_id', required: ['course_id'] };
...
exports.getProficiencyRatingsAccounts = { type: 'GET_PROFICIENCY_RATINGS_ACCOUNTS', method: 'get', key: 'get_proficiency_ratings_accountsget_proficiency_ratings_accounts_account_id', required: ['account_id'] };
// Get proficiency ratings
// Get account-level proficiency ratings. If not defined for this account,
// it will return proficiency ratings for the nearest super-account with ratings defined.
// Will return 404 if none found.
...
exports.getProficiencyRatingsCourses = { type: 'GET_PROFICIENCY_RATINGS_COURSES', method: 'get', key: 'get_proficiency_ratings_coursesget_proficiency_ratings_courses_course_id', required: ['course_id'] };
//# sourceMappingURL=proficiency_ratings.js.map