export namespace getAllPeerReviewsCoursesPeerReviews {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace getAllPeerReviewsSectionsPeerReviews {
    const type_1: string;
...
export namespace getAllPeerReviewsCoursesSubmissions {
    const type_2: string;
...
export namespace getAllPeerReviewsSectionsSubmissions {
    const type_3: string;
...
export namespace peerReviewsCreatePeerReviewCourses {
    const type_4: string;
...
export namespace peerReviewsCreatePeerReviewSections {
    const type_5: string;
...
export namespace deletePeerReviewCourses {
    const type_6: string;
...
export namespace deletePeerReviewSections {
    const type_7: string;
