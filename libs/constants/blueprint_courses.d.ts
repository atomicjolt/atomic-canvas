export namespace getBlueprintInformation {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace getAssociatedCourseInformation {
    const type_1: string;
...
export namespace updateAssociatedCourses {
    const type_2: string;
...
export namespace beginMigrationToPushToAssociatedCourses {
    const type_3: string;
...
export namespace setOrRemoveRestrictionsOnBlueprintCourseObject {
    const type_4: string;
...
export namespace getUnsyncedChanges {
    const type_5: string;
...
export namespace listBlueprintMigrations {
    const type_6: string;
...
export namespace showBlueprintMigration {
    const type_7: string;
...
export namespace getMigrationDetails {
    const type_8: string;
...
export namespace listBlueprintSubscriptions {
    const type_9: string;
...
export namespace listBlueprintImports {
...
export namespace showBlueprintImport {
...
export namespace getImportDetails {
