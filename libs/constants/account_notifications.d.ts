export namespace indexOfActiveGlobalNotificationForUser {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace showGlobalNotification {
    const type_1: string;
...
export namespace closeNotificationForUser {
    const type_2: string;
...
export namespace createGlobalNotification {
    const type_3: string;
...
export namespace updateGlobalNotification {
    const type_4: string;
