...
var indexOfActiveGlobalNotificationForUser = exports.indexOfActiveGlobalNotificationForUser = { type: 'INDEX_OF_ACTIVE_GLOBAL_NOTIFICATION_FOR_USER', method: 'get', key: 'index_of_active_global_notification_for_userindex_of_active_global_notification_for_user_{account_id}_{user_id}', required: ['account_id', 'user_id'] };
...
var showGlobalNotification = exports.showGlobalNotification = { type: 'SHOW_GLOBAL_NOTIFICATION', method: 'get', key: 'show_global_notificationshow_global_notification_{account_id}_{user_id}_{id}', required: ['account_id', 'user_id', 'id'] };
...
var closeNotificationForUser = exports.closeNotificationForUser = { type: 'CLOSE_NOTIFICATION_FOR_USER', method: 'delete', key: 'close_notification_for_userclose_notification_for_user_{account_id}_{user_id}_{id}', required: ['account_id', 'user_id', 'id'] };
