export namespace getAllQuizSubmissions {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace getQuizSubmission {
    const type_1: string;
...
export namespace getSingleQuizSubmission {
    const type_2: string;
...
export namespace createQuizSubmissionStartQuizTakingSession {
    const type_3: string;
...
export namespace updateStudentQuestionScoresAndComments {
    const type_4: string;
...
export namespace completeQuizSubmissionTurnItIn {
    const type_5: string;
...
export namespace getCurrentQuizSubmissionTimes {
    const type_6: string;
