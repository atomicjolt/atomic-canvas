export namespace listStudentsSelectedForModeration {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace selectStudentsForModeration {
    const type_1: string;
...
export namespace bulkSelectProvisionalGrades {
    const type_2: string;
...
export namespace showProvisionalGradeStatusForStudent {
    const type_3: string;
...
export namespace selectProvisionalGrade {
    const type_4: string;
...
export namespace publishProvisionalGradesForAssignment {
    const type_5: string;
...
export namespace moderatedGradingShowProvisionalGradeStatusForStudent {
    const type_6: string;
