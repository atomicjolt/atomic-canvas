export namespace getAllQuizSubmissionQuestions {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace answeringQuestions {
    const type_1: string;
...
export namespace getFormattedStudentNumericalAnswer {
    const type_2: string;
...
export namespace flaggingQuestion {
    const type_3: string;
...
export namespace unflaggingQuestion {
    const type_4: string;
