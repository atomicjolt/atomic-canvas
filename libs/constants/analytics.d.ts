export namespace getDepartmentLevelParticipationDataTerms {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace getDepartmentLevelParticipationDataCurrent {
    const type_1: string;
...
export namespace getDepartmentLevelParticipationDataCompleted {
    const type_2: string;
...
export namespace getDepartmentLevelGradeDataTerms {
    const type_3: string;
...
export namespace getDepartmentLevelGradeDataCurrent {
    const type_4: string;
...
export namespace getDepartmentLevelGradeDataCompleted {
    const type_5: string;
...
export namespace getDepartmentLevelStatisticsTerms {
    const type_6: string;
...
export namespace getDepartmentLevelStatisticsCurrent {
    const type_7: string;
...
export namespace getDepartmentLevelStatisticsCompleted {
    const type_8: string;
...
export namespace getDepartmentLevelStatisticsBrokenDownBySubaccountTerms {
    const type_9: string;
...
export namespace getDepartmentLevelStatisticsBrokenDownBySubaccountCurrent {
...
export namespace getDepartmentLevelStatisticsBrokenDownBySubaccountCompleted {
...
export namespace getCourseLevelParticipationData {
...
export namespace getCourseLevelAssignmentData {
...
export namespace getCourseLevelStudentSummaryData {
...
export namespace getUserInACourseLevelParticipationData {
...
export namespace getUserInACourseLevelAssignmentData {
...
export namespace getUserInACourseLevelMessagingData {
