...
export namespace getAccountsThatAdminsCanManage {
    const type_1: string;
    ...
    const key_1: string;
    export { key_1 as key };
    const required_1: never[];
    export { required_1 as required };
}
export namespace getAccountsThatUsersCanCreateCoursesIn {
    const type_2: string;
...
export namespace listAccountsForCourseAdmins {
    const type_3: string;
    ...
    const key_3: string;
    export { key_3 as key };
    const required_3: never[];
    export { required_3 as required };
}
export namespace getSingleAccount {
    const type_4: string;
...
export namespace getSubAccountsOfAccount {
    const type_7: string;
...
export namespace getTermsOfService {
    const type_8: string;
...
export namespace getManuallyCreatedCoursesSubAccountForDomainRootAccount {
    ...
    const required_10: never[];
    export { required_10 as required };
}
export namespace listActiveCoursesInAccount {
...
export namespace deleteUserFromRootAccount {
...
export namespace createNewSubAccount {
...
export namespace deleteSubAccount {
