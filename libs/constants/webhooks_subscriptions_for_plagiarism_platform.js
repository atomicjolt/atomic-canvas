...
var deleteWebhookSubscription = exports.deleteWebhookSubscription = { type: 'DELETE_WEBHOOK_SUBSCRIPTION', method: 'delete', key: 'delete_webhook_subscriptiondelete_webhook_subscription_id', required: ['id'] };
...
var showSingleWebhookSubscription = exports.showSingleWebhookSubscription = { type: 'SHOW_SINGLE_WEBHOOK_SUBSCRIPTION', method: 'get', key: 'show_single_webhook_subscriptionshow_single_webhook_subscription_id', required: ['id'] };
...
var updateWebhookSubscription = exports.updateWebhookSubscription = { type: 'UPDATE_WEBHOOK_SUBSCRIPTION', method: 'put', key: 'update_webhook_subscriptionupdate_webhook_subscription_id', required: ['id'] };
...
var listAllWebhookSubscriptionForToolProxy = exports.listAllWebhookSubscriptionForToolProxy = { type: 'LIST_ALL_WEBHOOK_SUBSCRIPTION_FOR_TOOL_PROXY', method: 'get', key: 'list_all_webhook_subscription_for_tool_proxy', required: [] };