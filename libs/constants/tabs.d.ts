export namespace listAvailableTabsForCourseOrGroupAccounts {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace listAvailableTabsForCourseOrGroupCourses {
    const type_1: string;
...
export namespace listAvailableTabsForCourseOrGroupGroups {
    const type_2: string;
...
export namespace listAvailableTabsForCourseOrGroupUsers {
    const type_3: string;
...
export namespace updateTabForCourse {
    const type_4: string;
