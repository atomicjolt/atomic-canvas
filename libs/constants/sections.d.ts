export namespace listCourseSections {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace createCourseSection {
    const type_1: string;
...
export namespace crossListSection {
    const type_2: string;
...
export namespace deCrossListSection {
    const type_3: string;
...
export namespace getSectionInformationCourses {
    const type_5: string;
...
export namespace getSectionInformationSections {
    const type_6: string;
