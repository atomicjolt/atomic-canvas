export namespace listPlannerItemsPlanner {
    const type: string;
    const method: string;
    const key: string;
    const required: never[];
}
export namespace listPlannerItemsUsers {
    const type_1: string;
...
export namespace listPlannerNotes {
    const type_2: string;
...
export namespace showPlannerNote {
    const type_3: string;
...
export namespace updatePlannerNote {
    const type_4: string;
...
export namespace createPlannerNote {
    const type_5: string;
    ...
    const key_5: string;
    export { key_5 as key };
    const required_5: never[];
    export { required_5 as required };
}
export namespace deletePlannerNote {
    const type_6: string;
...
export namespace listPlannerOverrides {
    const type_7: string;
...
export namespace showPlannerOverride {
    const type_8: string;
...
export namespace updatePlannerOverride {
    const type_9: string;
...
export namespace createPlannerOverride {
...
export namespace deletePlannerOverride {
