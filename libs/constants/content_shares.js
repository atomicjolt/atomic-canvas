...
exports.updateContentShare = exports.addUsersToContentShare = exports.removeContentShare = exports.getContentShare = exports.getUnreadSharesCount = exports.listContentSharesReceived = exports.listContentSharesSent = exports.createContentShare = void 0;
//
// Content Shares
//
...
exports.createContentShare = { type: 'CREATE_CONTENT_SHARE', method: 'post', key: 'create_content_sharecreate_content_share_user_id', required: ['user_id'] };
// List content shares
...
exports.listContentSharesSent = { type: 'LIST_CONTENT_SHARES_SENT', method: 'get', key: 'list_content_shares_sentlist_content_shares_sent_user_id', required: ['user_id'] };
// List content shares
// Return a paginated list of content shares a user has sent or received. Use +self+ as the user_id
// to retrieve your own content shares. Only linked observers and administrators may view other users'
// content shares.
...
exports.listContentSharesReceived = { type: 'LIST_CONTENT_SHARES_RECEIVED', method: 'get', key: 'list_content_shares_receivedlist_content_shares_received_user_id', required: ['user_id'] };
...
exports.getUnreadSharesCount = { type: 'GET_UNREAD_SHARES_COUNT', method: 'get', key: 'get_unread_shares_countget_unread_shares_count_user_id', required: ['user_id'] };
// Get content share
...
exports.getContentShare = { type: 'GET_CONTENT_SHARE', method: 'get', key: 'get_content_shareget_content_share_{user_id}_{id}', required: ['user_id', 'id'] };
...
exports.removeContentShare = { type: 'REMOVE_CONTENT_SHARE', method: 'delete', key: 'remove_content_shareremove_content_share_{user_id}_{id}', required: ['user_id', 'id'] };
...
exports.addUsersToContentShare = { type: 'ADD_USERS_TO_CONTENT_SHARE', method: 'post', key: 'add_users_to_content_shareadd_users_to_content_share_{user_id}_{id}', required: ['user_id', 'id'] };
...
exports.updateContentShare = { type: 'UPDATE_CONTENT_SHARE', method: 'put', key: 'update_content_shareupdate_content_share_{user_id}_{id}', required: ['user_id', 'id'] };
//# sourceMappingURL=content_shares.js.map