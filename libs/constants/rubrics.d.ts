export namespace createSingleRubric {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace updateSingleRubric {
    const type_1: string;
...
export namespace deleteSingleRubric {
    const type_2: string;
...
export namespace listRubricsAccounts {
    const type_3: string;
...
export namespace listRubricsCourses {
    const type_4: string;
...
export namespace getSingleRubricAccounts {
    const type_5: string;
...
export namespace getSingleRubricCourses {
    const type_6: string;
...
export namespace createSingleRubricAssessment {
    const type_7: string;
...
export namespace updateSingleRubricAssessment {
    const type_8: string;
...
export namespace deleteSingleRubricAssessment {
    const type_9: string;
...
export namespace createRubricassociation {
...
export namespace updateRubricassociation {
...
export namespace deleteRubricassociation {
