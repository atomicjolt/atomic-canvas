export namespace listObservees {
    const type: string;
    const method: string;
    const key: string;
    const required: string[];
}
export namespace listObservers {
    const type_1: string;
...
export namespace addObserveeWithCredentials {
    const type_2: string;
...
export namespace removeObservee {
    const type_6: string;
...
export namespace createObserverPairingCode {
    const type_7: string;
