...
export const listGradingPeriodSets = { type: 'LIST_GRADING_PERIOD_SETS', method: 'get', key: 'list_grading_period_setslist_grading_period_sets_account_id', required: ['account_id'] };
...
export const createGradingPeriodSet = { type: 'CREATE_GRADING_PERIOD_SET', method: 'post', key: 'create_grading_period_setcreate_grading_period_set_account_id', required: ['account_id'] };
...
export const updateGradingPeriodSet = { type: 'UPDATE_GRADING_PERIOD_SET', method: 'patch', key: 'update_grading_period_setupdate_grading_period_set_{account_id}_{id}', required: ['account_id', 'id'] };
...
export const deleteGradingPeriodSet = { type: 'DELETE_GRADING_PERIOD_SET', method: 'delete', key: 'delete_grading_period_setdelete_grading_period_set_{account_id}_{id}', required: ['account_id', 'id'] };