...
export const duplicateDiscussionTopicCourses = { type: 'DUPLICATE_DISCUSSION_TOPIC_COURSES', method: 'post', key: 'duplicate_discussion_topic_coursesduplicate_discussion_topic_courses_{course_id}_{topic_id}', required: ['course_id', 'topic_id'] };
...
export const duplicateDiscussionTopicGroups = { type: 'DUPLICATE_DISCUSSION_TOPIC_GROUPS', method: 'post', key: 'duplicate_discussion_topic_groupsduplicate_discussion_topic_groups_{group_id}_{topic_id}', required: ['group_id', 'topic_id'] };
