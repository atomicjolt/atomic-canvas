...
export const updateMediaObject = { type: 'UPDATE_MEDIA_OBJECT', method: 'put', key: 'update_media_objectupdate_media_object_media_object_id', required: ['media_object_id'] };