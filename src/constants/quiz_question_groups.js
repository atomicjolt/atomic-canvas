...
export const getSingleQuizGroup = { type: 'GET_SINGLE_QUIZ_GROUP', method: 'get', key: 'get_single_quiz_groupget_single_quiz_group_{course_id}_{quiz_id}_{id}', required: ['course_id', 'quiz_id', 'id'] };
...
export const deleteQuestionGroup = { type: 'DELETE_QUESTION_GROUP', method: 'delete', key: 'delete_question_groupdelete_question_group_{course_id}_{quiz_id}_{id}', required: ['course_id', 'quiz_id', 'id'] };
