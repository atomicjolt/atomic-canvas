...
export const showCollectionOfResults = { type: 'SHOW_COLLECTION_OF_RESULTS', method: 'get', key: 'show_collection_of_resultsshow_collection_of_results_{course_id}_{line_item_id}', required: ['course_id', 'line_item_id'] };
...
export const showResult = { type: 'SHOW_RESULT', method: 'get', key: 'show_resultshow_result_{course_id}_{line_item_id}_{id}', required: ['course_id', 'line_item_id', 'id'] };