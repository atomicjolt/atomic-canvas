...
export const listBlueprintSubscriptions = { type: 'LIST_BLUEPRINT_SUBSCRIPTIONS', method: 'get', key: 'list_blueprint_subscriptionslist_blueprint_subscriptions_course_id', required: ['course_id'] };
