...
export const listAvailableAccountCalendars = { type: 'LIST_AVAILABLE_ACCOUNT_CALENDARS', method: 'get', key: 'list_available_account_calendars', required: [] };
...
export const getSingleAccountCalendar = { type: 'GET_SINGLE_ACCOUNT_CALENDAR', method: 'get', key: 'get_single_account_calendarget_single_account_calendar_account_id', required: ['account_id'] };
...
export const updateCalendar = { type: 'UPDATE_CALENDAR', method: 'put', key: 'update_calendarupdate_calendar_account_id', required: ['account_id'] };
...
export const updateSeveralCalendars = { type: 'UPDATE_SEVERAL_CALENDARS', method: 'put', key: 'update_several_calendarsupdate_several_calendars_account_id', required: ['account_id'] };
...
export const listAllAccountCalendars = { type: 'LIST_ALL_ACCOUNT_CALENDARS', method: 'get', key: 'list_all_account_calendarslist_all_account_calendars_account_id', required: ['account_id'] };
...
export const countOfAllVisibleAccountCalendars = { type: 'COUNT_OF_ALL_VISIBLE_ACCOUNT_CALENDARS', method: 'get', key: 'count_of_all_visible_account_calendarscount_of_all_visible_account_calendars_account_id', required: ['account_id'] };