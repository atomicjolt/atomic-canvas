...
export const getSingleAssignmentLti = { type: 'GET_SINGLE_ASSIGNMENT_LTI', method: 'get', key: 'get_single_assignment_ltiget_single_assignment_lti_assignment_id', required: ['assignment_id'] };