...
export const listRecentHistoryForUser = { type: 'LIST_RECENT_HISTORY_FOR_USER', method: 'get', key: 'list_recent_history_for_userlist_recent_history_for_user_user_id', required: ['user_id'] };