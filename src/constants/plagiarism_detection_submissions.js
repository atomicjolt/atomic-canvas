...
export const getSingleSubmission = { type: 'GET_SINGLE_SUBMISSION', method: 'get', key: 'get_single_submissionget_single_submission_{assignment_id}_{submission_id}', required: ['assignment_id', 'submission_id'] };
...
export const getHistoryOfSingleSubmission = { type: 'GET_HISTORY_OF_SINGLE_SUBMISSION', method: 'get', key: 'get_history_of_single_submissionget_history_of_single_submission_{assignment_id}_{submission_id}', required: ['assignment_id', 'submission_id'] };