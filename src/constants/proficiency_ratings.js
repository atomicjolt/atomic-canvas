...
export const createUpdateProficiencyRatingsAccounts = { type: 'CREATE_UPDATE_PROFICIENCY_RATINGS_ACCOUNTS', method: 'post', key: 'create_update_proficiency_ratings_accountscreate_update_proficiency_ratings_accounts_account_id', required: ['account_id'] };
...
export const createUpdateProficiencyRatingsCourses = { type: 'CREATE_UPDATE_PROFICIENCY_RATINGS_COURSES', method: 'post', key: 'create_update_proficiency_ratings_coursescreate_update_proficiency_ratings_courses_course_id', required: ['course_id'] };
...
export const getProficiencyRatingsAccounts = { type: 'GET_PROFICIENCY_RATINGS_ACCOUNTS', method: 'get', key: 'get_proficiency_ratings_accountsget_proficiency_ratings_accounts_account_id', required: ['account_id'] };
...
export const getProficiencyRatingsCourses = { type: 'GET_PROFICIENCY_RATINGS_COURSES', method: 'get', key: 'get_proficiency_ratings_coursesget_proficiency_ratings_courses_course_id', required: ['course_id'] };