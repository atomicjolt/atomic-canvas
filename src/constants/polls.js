...
export const listPolls = { type: 'LIST_POLLS', method: 'get', key: 'list_polls', required: [] };
...
export const createSinglePoll = { type: 'CREATE_SINGLE_POLL', method: 'post', key: 'create_single_poll', required: [] };
