...
export const getIdsOfOutcomeGroupsCreatedAfterSuccessfulImportAccounts = { type: 'GET_IDS_OF_OUTCOME_GROUPS_CREATED_AFTER_SUCCESSFUL_IMPORT_ACCOUNTS', method: 'get', key: 'get_ids_of_outcome_groups_created_after_successful_import_accountsget_ids_of_outcome_groups_created_after_successful_import_accounts_{account_id}_{id}', required: ['account_id', 'id'] };
