...
export const fetchingLatestQuizStatistics = { type: 'FETCHING_LATEST_QUIZ_STATISTICS', method: 'get', key: 'fetching_latest_quiz_statisticsfetching_latest_quiz_statistics_{course_id}_{quiz_id}', required: ['course_id', 'quiz_id'] };