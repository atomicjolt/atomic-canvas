...
export const listPollChoicesInPoll = { type: 'LIST_POLL_CHOICES_IN_POLL', method: 'get', key: 'list_poll_choices_in_polllist_poll_choices_in_poll_poll_id', required: ['poll_id'] };
