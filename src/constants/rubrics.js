...
export const deleteSingleRubric = { type: 'DELETE_SINGLE_RUBRIC', method: 'delete', key: 'delete_single_rubricdelete_single_rubric_{course_id}_{id}', required: ['course_id', 'id'] };
...
export const createSingleRubricAssessment = { type: 'CREATE_SINGLE_RUBRIC_ASSESSMENT', method: 'post', key: 'create_single_rubric_assessmentcreate_single_rubric_assessment_{course_id}_{rubric_association_id}', required: ['course_id', 'rubric_association_id'] };
...
export const updateSingleRubricAssessment = { type: 'UPDATE_SINGLE_RUBRIC_ASSESSMENT', method: 'put', key: 'update_single_rubric_assessmentupdate_single_rubric_assessment_{course_id}_{rubric_association_id}_{id}', required: ['course_id', 'rubric_association_id', 'id'] };
...
export const deleteSingleRubricAssessment = { type: 'DELETE_SINGLE_RUBRIC_ASSESSMENT', method: 'delete', key: 'delete_single_rubric_assessmentdelete_single_rubric_assessment_{course_id}_{rubric_association_id}_{id}', required: ['course_id', 'rubric_association_id', 'id'] };
...
export const createRubricassociation = { type: 'CREATE_RUBRICASSOCIATION', method: 'post', key: 'create_rubricassociationcreate_rubricassociation_course_id', required: ['course_id'] };
...
export const updateRubricassociation = { type: 'UPDATE_RUBRICASSOCIATION', method: 'put', key: 'update_rubricassociationupdate_rubricassociation_{course_id}_{id}', required: ['course_id', 'id'] };
...
export const deleteRubricassociation = { type: 'DELETE_RUBRICASSOCIATION', method: 'delete', key: 'delete_rubricassociationdelete_rubricassociation_{course_id}_{id}', required: ['course_id', 'id'] };