...
export const findImages = { type: 'FIND_IMAGES', method: 'get', key: 'find_images', required: [] };
...
export const confirmImageSelection = { type: 'CONFIRM_IMAGE_SELECTION', method: 'post', key: 'confirm_image_selectionconfirm_image_selection_id', required: ['id'] };