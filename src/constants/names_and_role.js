...
export const listCourseMemberships = { type: 'LIST_COURSE_MEMBERSHIPS', method: 'get', key: 'list_course_membershipslist_course_memberships_course_id', required: ['course_id'] };
...
export const namesAndRoleListGroupMemberships = { type: 'NAMES_AND_ROLE_LIST_GROUP_MEMBERSHIPS', method: 'get', key: 'names_and_role_list_group_membershipsnames_and_role_list_group_memberships_group_id', required: ['group_id'] };