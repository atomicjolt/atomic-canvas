...
export const showGlobalNotification = { type: 'SHOW_GLOBAL_NOTIFICATION', method: 'get', key: 'show_global_notificationshow_global_notification_{account_id}_{id}', required: ['account_id', 'id'] };
...
export const closeNotificationForUser = { type: 'CLOSE_NOTIFICATION_FOR_USER', method: 'delete', key: 'close_notification_for_userclose_notification_for_user_{account_id}_{id}', required: ['account_id', 'id'] };
