...
export const listPreferencesCommunicationChannelId = { type: 'LIST_PREFERENCES_COMMUNICATION_CHANNEL_ID', method: 'get', key: 'list_preferences_communication_channel_idlist_preferences_communication_channel_id_{user_id}_{communication_channel_id}', required: ['user_id', 'communication_channel_id'] };
...
export const listPreferencesType = { type: 'LIST_PREFERENCES_TYPE', method: 'get', key: 'list_preferences_typelist_preferences_type_{user_id}_{type}_{address}', required: ['user_id', 'type', 'address'] };
...
export const getPreferenceType = { type: 'GET_PREFERENCE_TYPE', method: 'get', key: 'get_preference_typeget_preference_type_{user_id}_{type}_{address}_{notification}', required: ['user_id', 'type', 'address', 'notification'] };
...
export const updatePreferenceCommunicationChannelId = { type: 'UPDATE_PREFERENCE_COMMUNICATION_CHANNEL_ID', method: 'put', key: 'update_preference_communication_channel_idupdate_preference_communication_channel_id_{communication_channel_id}_{notification}', required: ['communication_channel_id', 'notification'] };
...
export const updatePreferenceType = { type: 'UPDATE_PREFERENCE_TYPE', method: 'put', key: 'update_preference_typeupdate_preference_type_{type}_{address}_{notification}', required: ['type', 'address', 'notification'] };
...
export const updatePreferencesByCategory = { type: 'UPDATE_PREFERENCES_BY_CATEGORY', method: 'put', key: 'update_preferences_by_categoryupdate_preferences_by_category_{communication_channel_id}_{category}', required: ['communication_channel_id', 'category'] };
...
export const updateMultiplePreferencesCommunicationChannelId = { type: 'UPDATE_MULTIPLE_PREFERENCES_COMMUNICATION_CHANNEL_ID', method: 'put', key: 'update_multiple_preferences_communication_channel_idupdate_multiple_preferences_communication_channel_id_communication_channel_id', required: ['communication_channel_id'] };
...
export const updateMultiplePreferencesType = { type: 'UPDATE_MULTIPLE_PREFERENCES_TYPE', method: 'put', key: 'update_multiple_preferences_typeupdate_multiple_preferences_type_{type}_{address}', required: ['type', 'address'] };