...
export const retrieveAssignmentOverriddenDatesForClassicQuizzes = { type: 'RETRIEVE_ASSIGNMENT_OVERRIDDEN_DATES_FOR_CLASSIC_QUIZZES', method: 'get', key: 'retrieve_assignment_overridden_dates_for_classic_quizzesretrieve_assignment_overridden_dates_for_classic_quizzes_course_id', required: ['course_id'] };
...
export const retrieveAssignmentOverriddenDatesForNewQuizzes = { type: 'RETRIEVE_ASSIGNMENT_OVERRIDDEN_DATES_FOR_NEW_QUIZZES', method: 'get', key: 'retrieve_assignment_overridden_dates_for_new_quizzesretrieve_assignment_overridden_dates_for_new_quizzes_course_id', required: ['course_id'] };