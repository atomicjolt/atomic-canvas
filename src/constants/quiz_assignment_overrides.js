...
export const retrieveAssignmentOverriddenDatesForQuizzes = { type: 'RETRIEVE_ASSIGNMENT_OVERRIDDEN_DATES_FOR_QUIZZES', method: 'get', key: 'retrieve_assignment_overridden_dates_for_quizzesretrieve_assignment_overridden_dates_for_quizzes_course_id', required: ['course_id'] };