...
export const getAllEportfoliosForUser = { type: 'GET_ALL_EPORTFOLIOS_FOR_USER', method: 'get', key: 'get_all_eportfolios_for_userget_all_eportfolios_for_user_user_id', required: ['user_id'] };
...
export const getEportfolio = { type: 'GET_EPORTFOLIO', method: 'get', key: 'get_eportfolioget_eportfolio_id', required: ['id'] };
...
export const deleteEportfolio = { type: 'DELETE_EPORTFOLIO', method: 'delete', key: 'delete_eportfoliodelete_eportfolio_id', required: ['id'] };
...
export const getEportfolioPages = { type: 'GET_EPORTFOLIO_PAGES', method: 'get', key: 'get_eportfolio_pagesget_eportfolio_pages_eportfolio_id', required: ['eportfolio_id'] };
...
export const moderateEportfolio = { type: 'MODERATE_EPORTFOLIO', method: 'put', key: 'moderate_eportfoliomoderate_eportfolio_eportfolio_id', required: ['eportfolio_id'] };
...
export const moderateAllEportfoliosForUser = { type: 'MODERATE_ALL_EPORTFOLIOS_FOR_USER', method: 'put', key: 'moderate_all_eportfolios_for_usermoderate_all_eportfolios_for_user_user_id', required: ['user_id'] };
...
export const restoreDeletedEportfolio = { type: 'RESTORE_DELETED_EPORTFOLIO', method: 'put', key: 'restore_deleted_eportfoliorestore_deleted_eportfolio_eportfolio_id', required: ['eportfolio_id'] };